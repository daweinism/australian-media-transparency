...
Every visual answers: what am I looking at, what does it mean, why should I care — without requiring a click.

- One dominant visual per screen
- Short plain-English explanation on the screen itself
- One important number or relationship
- Detail panels (`Why this matters`, `Legal detail`, `Our analysis`) add depth only
- Scroll teaches; clicks deepen

## Chapters (≈ 2–4 minutes)

1. **Start** — Australian news · diversity · NBI 2026 · transparency
2. **Diversity** — one voice → many kinds of newsroom
3. **Resources** — large team vs small team · who can keep reporting?
4. **2021–2026** — bargaining code → deals → exit risk → News Bargaining Incentive
...
8. **The money** — platform → charge/spending → scheme → newsrooms → public
9. **Scale ≠ diversity** — our analysis
10. **Transparency → proposal** — black box opens; disclose · review · report · widen
11. **End** — return to the opening question · evidence
...
Static HTML / CSS / JS (ES modules) / SVG. No build step, no backend, no paid services. Relative paths for GitHub Pages sub-path hosting.
